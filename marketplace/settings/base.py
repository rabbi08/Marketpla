...
ADMINS = (("Admins", "info@duingud.com"),)
MANAGERS = ADMINS
EMAIL_SUBJECT_PREFIX = "[Marketplace] "  # subject prefix for managers & admins

SESSION_COOKIE_NAME = "marketplace_ssid"
...
DATABASES = {
    ...
    "default": env.db_url(
        ...
        default="psql://{user}:{password}@{host}:{port}/{name}?sslmode={sslmode}".format(
            ...
            name=quote(env.str("DJANGO_DATABASE_NAME", default="marketplace")),
            user=quote(env.str("DJANGO_DATABASE_USER", default="marketplace")),
            password=quote(env.str("DJANGO_DATABASE_PASSWORD", default="marketplace")),
...
# Email config
DEFAULT_FROM_EMAIL = "Marketplace <info@duingud.com>"
SERVER_EMAIL = "Marketplace server <server@duingud.com>"
