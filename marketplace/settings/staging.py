...
ALLOWED_HOSTS = env.list(
    ...
    default=["marketplace.review.duingud.com"],

)
# fmt: on

# Static site url, used when we need absolute url but lack request object, e.g. in email sending.
SITE_URL = env.str("DJANGO_SITE_URL", default="https://marketplace.review.duingud.com")
    ...
    LOGGING["handlers"].update(
        {
            "info_log": {
                ...
                "filename": "/var/log/marketplace/info.log",
                "formatter": "default",
            },
            "error_log": {
                "level": "ERROR",
...
AWS_STORAGE_BUCKET_NAME = env.str(
    "DJANGO_AWS_STORAGE_BUCKET_NAME", default="marketplace-staging"
)
